...
# Form implementation generated from reading ui file 'C:\Repo\farmng_amigacontrol\gui\MyWeed.ui'
#
...
class Ui_OpenWeedGUI(object):
    def setupUi(self, OpenWeedGUI):
        ...
        self.widget.setMaximumSize(QtCore.QSize(3000, 16777215))
...
"")
        ...
        self.comboBox_model_name = QtWidgets.QComboBox(self.frame)
        self.comboBox_model_name.setMinimumSize(QtCore.QSize(0, 35))
        self.comboBox_model_name.setStyleSheet("QComboBox QAbstractItemView {\n"
"font-family: \"Microsoft YaHei\";\n"
"font-size: 16px;\n"
"\n"
...
"")
        ...
        self.IntensitySpinBox.setMinimumSize(QtCore.QSize(60, 0))
        self.IntensitySpinBox.setMaximumSize(QtCore.QSize(50, 22))
...
"}")
        ...
        self.horizontalLayout_13.addWidget(self.ReControl)
...
"")
        ...
        self.label_pic.setMaximumSize(QtCore.QSize(2000, 2000))
        self.label_pic.setBaseSize(QtCore.QSize(800, 800))
...
"background-color: rgba(223, 223, 223, 150);}")
    ...
    def retranslateUi(self, OpenWeedGUI):
        ...
        self.comboBox_model_name.setItemText(0, _translate("OpenWeedGUI", "yolov10"))
        self.comboBox_pt.setItemText(0, _translate("OpenWeedGUI", "bestS.pt"))
        ...
        self.label_2.setText(_translate("OpenWeedGUI", "Save Interval :"))
        self.label_25.setText(_translate("OpenWeedGUI", "Saving Resolution :"))
        self.comboBox_4.setCurrentText(_translate("OpenWeedGUI", "800*800"))
        self.comboBox_4.setItemText(0, _translate("OpenWeedGUI", "640*640"))
        self.comboBox_4.setItemText(1, _translate("OpenWeedGUI", "800*800"))
        self.comboBox_4.setItemText(2, _translate("OpenWeedGUI", "512*512"))
        self.comboBox_4.setItemText(3, _translate("OpenWeedGUI", "1920*1080"))
        ...
        self.ReControl.setText(_translate("OpenWeedGUI", "Valve Status Change, No."))
        self.label_11.setText(_translate("OpenWeedGUI", "Valve status"))
        ...
        item.setText(_translate("OpenWeedGUI", "Valve No.1: Open "))
        item = self.resultWidget.item(1)
        item.setText(_translate("OpenWeedGUI", "Valve No.2: Closed "))
        item = self.resultWidget.item(2)
        item.setText(_translate("OpenWeedGUI", "Valve No.3: Closed"))
        item = self.resultWidget.item(3)
        item.setText(_translate("OpenWeedGUI", "Valve No.4: Closed"))
        item = self.resultWidget.item(4)
        item.setText(_translate("OpenWeedGUI", "Valve No.5: Closed"))
        item = self.resultWidget.item(5)
        item.setText(_translate("OpenWeedGUI", "Valve No.6: Closed"))
        item = self.resultWidget.item(6)
        item.setText(_translate("OpenWeedGUI", "Valve No.7: Closed"))
        item = self.resultWidget.item(7)
        item.setText(_translate("OpenWeedGUI", "Valve No.8: Closed"))
        item = self.resultWidget.item(8)
        item.setText(_translate("OpenWeedGUI", "Valve No.9: Closed"))
        item = self.resultWidget.item(9)
        item.setText(_translate("OpenWeedGUI", "Valve No.10: Closed"))
        item = self.resultWidget.item(10)
        item.setText(_translate("OpenWeedGUI", "Valve No.11: Closed"))
        item = self.resultWidget.item(11)
        item.setText(_translate("OpenWeedGUI", "Valve No.12: Closed"))
        self.resultWidget.setSortingEnabled(__sortingEnabled)
        self.label_speed.setText(_translate("OpenWeedGUI", "Current Speed:"))
        self.label_26.setText(_translate("OpenWeedGUI", "Smart Sprayer Viewpoint"))
